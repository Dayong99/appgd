<template>
  <view style="">
	  <view style="position: fixed;top:0;left: 0;width: 100%;background: #fff;z-index: 888;">
		  ...
		  <view class="bfff0 pl33r hl69r w100v mt19r mb28r score_tips">
		  		  <text v-if="noneread">还需观看 <text class="cee mlr20r">{{artentList.readTime}}</text>，获取 <text class="cee">+{{artentList.score}} </text>分</text>
		  		  <text v-if="haveread" class="cee mlr20r">谢谢您的观看，您已获得 +{{artentList.score}} 分！</text>
		  		   <text v-if="moreread" class="cee mlr20r f28r">谢谢您的阅读，今日文章已超过上限，此次阅读未有积分！</text>
		  </view>
	  </view>
