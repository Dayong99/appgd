<template>
  <view>
    ...
    <!-- 滚动内容区 -->
    <mescroll-uni @down="downCallback" @up="upCallback" :down="down" :up="up" @init="mescrollInit" :top="133">
      ...
      upCallback(mescroll) {
        getUserAtteUserList({
          ...
          if (mescroll.num == 1) {
            ...
            this.$store.commit('user/setUserFansListData', this.userAtteUserListData.concat(atteRes.data.result.records))
          } 
