<template>
	<view class="posir jkent">
		<!-- 顶部封面 -->
		<image class="w100v mb64r" src="/static/homelog.png" mode="widthFix"></image>
		<!-- 表单 -->
		<image src="../../static/touxiang.png" class="touxiang posia"></image>
		<view class="mlr64r">
			...
			<view class="privacy f26r cgray">
				...
				请详细阅读安全积分系统<text style="color:#ff9900" @click="privacys">隐私政策</text>
				</text>
				</label>
			</view>
			<button class="loginsent" hover-class="btn-hover" @tap="fnLogin" :disabled="isLogin"
