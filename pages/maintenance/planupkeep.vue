				...
				<view class="beamList" style="">
					...
					<view class="plancontent">
						<view v-for="child in item.deviceMaintainPlanSubList" class="planchildlist">
							 <view class="planterm">
								<text class="goplan" :class="{'colortype':child.maintainStatus!==0}">{{child.maintainStatus_dictText}}</text>
							...
							<view class="contengbox">
								<view class="botmeg">
								 ...
								 <view class="routing" @click="searcgvaky('maintain',child)" v-if="child.maintainStatus==0">去保养</view>
							</view> 
						</view>
					</view>
				</view>
