<template>
	<view style="position: relative;top:0;bottom: 0;background: #fff;z-index: 999;">
		<!-- 滚动内容区 -->
		...
		<view>
			...
			<view class="processlist">
				...
				<view class="listrig">
					<picker @change="changePeople" :value="personIndex" :range="personList" :range-key="'personName'">
						<view class="uni-input" v-if="personIndex!==''">{{personList[personIndex].personName}}
						</view>
			...
			<view class="processlist">
				...
				<view class="listrig">
					<picker @change="changeRepair" :value="repairIndex" :range="repairList" :range-key="'personName'">
						<view class="uni-input" v-if="repairIndex!==''">{{repairList[repairIndex].personName}}
						</view>
			...
			<block v-if="chosePage==1">
				<view class="processlist">
					...
					<view class="listrig">
						<picker @change="changeDeviceType" :value="index3" :range="typeList"
							:range-key="'deviceTypeName'">
				...
				<view class="processlist">
					...
					<view class="listrig">
						<picker @change="changeDevice" :value="index2" :range="deviceList" :range-key="'deviceName'">
							<view class="uni-input" v-if="index2 !== ''">
								{{deviceList.length > 0 ? deviceList[index2].deviceName: ''}}
							</view>
		...
		<view class="buttonyes" @tap="yesword" style="position: absolute;top: 1035rpx;">提交</view>
		<view class="buttoncancel" @tap="goback" style="position: absolute;top: 1040rpx;margin-bottom: 30rpx;">取消</view>
	</view>
</template>
<script>
		...
		methods: {
			...
			yesword() {
				...
				let data = {
					...
					deviceId: this.chosePage == 1 ?
						this.deviceList[this.index2].id : this.parentVal.id,
