  ...
  <view class="" style="position: relative;top:0;bottom: 0;background: #fff;z-index: 999;">
	...
	<view class="wagdetail">
			  <view class="flex listwag">
				  <view>头像</view>
				  <view></view> 
				  <view><image src="../../static/touxiang.png" mode="" class="persons" @tap="previewImg(srcIMG)"></image></view>
			  </view>
			  <view class="flex listwag">
				  <view>姓名</view>
				  <view></view>
				  <view>{{newsTotalData.personName?newsTotalData.personName:newsTotalData.realname}}</view>
			  </view>
			  <view class="flex listwag">
				  <view>年龄</view>
				  <view></view>
			  ...
			  <view class="flex listwag">
			  			  <view>手机</view>
			  			  <view></view>
			  			  <view>{{newsTotalData.phone?newsTotalData.phone:''}}</view>
			  </view>
	</view>
  </view>
</template>
<script>
  export default {
    ...
    computed: {
	  newsTotalData() {
		  // console.log(this.$store.getters['user/getAccountInfoData'])
