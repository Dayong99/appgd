	...
	<view class="page_cont">
		...
		<view class="cloud_cont">
			<view class="monitor-nav">
				<view class="title" v-for="(item,index) in monitorNav" :class="selectIndex==index ? 'active':''" @click="chooseNav(index)">{{item}}<view class="spoticon"></view></view>
			</view>
			<view class="cloud" v-show="selectIndex==0">
				...
				<view class="direction">
					...
					<!-- <view class="close_cloud" @click="turnOn" v-if="!startControl">{{controlText}}</view> -->
			...
			<view class="time-picker" v-show="selectIndex==1">
				<view class="time-picker-box">
					<view class="time-picker-block clearfix">
						...
						<view class="time-picker-cont">
							<uni-datetime-picker type="datetime" :value="start" @change="startTimeChange" ref="starttime"></uni-datetime-picker>
							<!-- <a-date-picker
								:allowClear="false"
							    :locale="locale"
							...
							<img class="timeicon" src="../../static/rilitime.png"/>
						</view>
					...
					<view class="time-picker-block clearfix">
						...
						<view class="time-picker-cont">
							<uni-datetime-picker type="datetime" :value="end" @change="endTimeChange" ref="endtime"></uni-datetime-picker>
							<!-- <a-date-picker
								:allowClear="false"
							    :locale="locale"
								format="YYYY-MM-DD HH:mm:ss"
			...
			<view class="backQ" @click="goBack">返回</view>
	</view>
</template>
